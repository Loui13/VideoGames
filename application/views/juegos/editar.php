...
<div class="row">
  <div class="col-md-12 text-center well">
    <h3><b>EDITAR DATOS JUEGOS</b> </h3>
  </div>
  <center>
    <a href="<?php echo site_url('juegos/index') ?>" class="btn btn-primary"><i class="glyphicon glyphicon-arrow-left"></i> REGRESAR</a>
  </center>
  <br>
  <div class="row">
    <div class="col-md-12">
      <?php if ($juegoEditar): ?>
        ...
        <form  class="" action="<?php echo site_url('juegos/procesarActualizacion') ?>" method="post" >
          <center>
          ...
          <br>
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                ...
                <a href="<?php echo site_url('juegos/index') ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i>CANCELAR</a>
              </div>
            </div>
        </form>
      <?php else: ?>
        <div class="alert alert-danger">
          <b>NO SE ENCONTRÓ JUEGOS</b>
        </div>
      <?php endif; ?>
    </div>
  </div>
